import { FETCH_MEALS_BEGIN, FETCH_MEALS_FAILURE, FETCH_MEALS_SUCCESS, GET_RANDOM_MEAL, GET_SINGLE_MEAL, SEARCH_MEAL } from "./mealTypes"
...
export const fetchSearchMeal = (input) =>{
    return(dispatch)=>{
        dispatch(fetchMealsBegin)
